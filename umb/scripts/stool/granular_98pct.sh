...
env JAX_PLATFORM_NAME=cpu \
  ...
  -o /mnt/e/ecoli_db/chronostrain_files/ecoli.98pct.txt \
  --ident-threshold 0.98
...
granular_breadcrumb=${run_dir}/inference_98pct.DONE
...
if ! [ -f $filter_breadcrumb ]; then
  ...
  chronostrain advi \
    -r ${run_dir}/filtered/filtered_reads.csv \
    -o ${run_dir}/chronostrain_98pct \
    -s /mnt/e/ecoli_db/chronostrain_files/ecoli.98pct.txt \
